...
import changePassword from "./api/routes_users/changePassword.js";
import changeNickname from "./api/routes_users/changeNickname.js";
...
app.use("/api/users/change-password", changePassword);
app.use("/api/users/change-nickname", changeNickname);
