...
const CardsMainCategories = () => {
    ...
    return (
        <>
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 w-full gap-3 sm:gap-4 bg-slate-50 dark:bg-slate-800 p-5 rounded-xl shadow-lg hover:shadow-md transition-all duration-300">
