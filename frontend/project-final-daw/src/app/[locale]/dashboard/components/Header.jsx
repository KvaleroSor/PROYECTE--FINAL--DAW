...
const Header = () => {
    ...
    return (
        <>
            <header className="w-full lg:fixed lg:top-0 lg:left-60 lg:right-0 lg:w-auto z-30 min-h-[80px] lg:h-[100px] flex justify-center items-center transition-colors duration-300 px-2 sm:px-4 lg:px-4 mr-1 sm:mr-2 lg:mr-4">
                <div className="w-full h-full flex flex-row justify-between items-center bg-slate-50 dark:bg-slate-800 shadow-lg hover:shadow-md transition-all duration-300 py-3 rounded-xl">
