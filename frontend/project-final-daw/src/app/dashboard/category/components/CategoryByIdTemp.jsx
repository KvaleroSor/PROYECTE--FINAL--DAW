    ...
    return (
        <>
            {!isCategory || !isCategory.color ? (
                ...
                <div className="w-[250px] group relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:border-slate-300 transition-all duration-300 overflow-hidden cursor-pointer">
