                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-200 hover:shadow-md hover:border-slate-300 transition-shadow">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <h1 className="text-slate-500">INVERTIDO</h1>
                        </div>
                        <h1 className="text-4xl text-slate-900 mb-1">
                            € {Number(isTotalInverted).toFixed(2)}
                        </h1>
                        <p className="text-slate-500">Total invertido</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-200 hover:shadow-md hover:border-slate-300 transition-shadow">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <h1 className="text-slate-500">GANANCIA</h1>
                        </div>
                        <h1 className="text-4xl text-green-600 mb-1">
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-200 hover:shadow-md hover:border-slate-300 transition-shadow">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <h1 className="text-slate-500">VALOR TOTAL</h1>
                        </div>
                        <h1 className="text-4xl text-blue-600 mb-1">
                            € {Number(isTotalValue).toFixed(2)}
                        </h1>
                        <p className="text-slate-500">Inversión + Ganancia</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-200 hover:shadow-md hover:border-slate-300 transition-shadow">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <h1 className="text-slate-500">RENTABILIDAD</h1>
                        </div>
                        <h1 className="text-4xl text-purple-600 mb-1">
                            {Number(isAverageProfitability).toFixed(2)} %
                        </h1>
                        <p className="text-slate-500">Rentabilidad media</p>
                    </div>
                </div>
            </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-slate-200">
                                    ...
                                    <th className="text-right py-3 px-4 text-slate-600 font-medium">Cantidad</th>
                                    <th className="text-right py-3 px-4 text-slate-600 font-medium">Rent. Objetivo</th>
                                    <th className="text-right py-3 px-4 text-slate-600 font-medium">Rent. Real</th>
                                    <th className="text-right py-3 px-4 text-slate-600 font-medium">Valor Total</th>
                                    <th className="text-center py-3 px-4 text-slate-600 font-medium">Fecha</th>
                                </tr>
                            </thead>
                            <tbody>
                                {isInversions.map((inversion) => {
                                    ...
                                    return (
                                        <tr key={inversion._id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="py-3 px-4 text-right">
                                                <span className={`font-medium ${
                                                    (inversion.real_profitability || 0) >= 0 
                                                        ? 'text-green-600' 
                                                        : 'text-red-600'
                                                }`}>
